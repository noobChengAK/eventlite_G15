...
public class HomePageTest {
	...
	//This test fails because the home page is now dynamic instead of static. Since there is a GetMapping to this url, a JSON request will not be accepted (406) instead of not found (406)
	//@Test
